...
Notification = StartedNotification | IpcNotification | ClosedNotification
""" 
...
ResultType = StringResultType | BooleanResultType | FloatResultType | SizeResultType
""" 
...
Response = AckResponse | ResultResponse | ErrResponse
""" 
...
Content = ContentUrl | ContentHtml
""" 
...
WindowSize = WindowSizeStates | Size
...
class Options(msgspec.Struct, omit_defaults=True):
    ...
    acceptFirstMouse: bool | None = None
...
Platform-specific: - Windows: Requires WebView2 Runtime version 101.0.1210.39 or higher, does nothing on older versions, see https://learn.microsoft.com/en-us/microsoft-edge/webview2/release-notes/archive?tabs=dotnetcsharp#10121039"""
    initializationScript: str | None = None
...
class GetSizeRequest(msgspec.Struct, tag_field="$type", tag="getSize"):
    id: int
    """The id of the request."""
    include_decorations: bool | None = None
